...
namespace Api.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        [HttpPost("Login")]
        public async Task<ActionResult<UsuariosModel>> Login([FromBody] UsuariosModel userModel)
        {
            UsuariosModel usuario = await _usuariosRepositorio.Login(userModel.UsuarioEmail, userModel.UsuarioSenha);
            return Ok(usuario);
        }
